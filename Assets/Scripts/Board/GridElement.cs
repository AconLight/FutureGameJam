...
public class GridElement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject cb = Instantiate(cube, new Vector3(transform.position.x,transform.position.y-0.9f, transform.position.z), Quaternion.identity, transform) as GameObject;
